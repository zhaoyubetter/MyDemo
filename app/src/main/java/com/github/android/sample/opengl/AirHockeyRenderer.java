...
public class AirHockeyRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        String vertexShaderSource = TextResourceReaderKt
            .readTextFileFromResource(context, R.raw.gl_simple_vertex_shader);
        String fragmentShaderSource = TextResourceReaderKt
            .readTextFileFromResource(context, R.raw.gl_simple_fragment_shader);
